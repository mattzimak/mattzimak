...
- [Museverse](https://museverse.xyz) - XR music-education app Matt co-founded (COO). A mixed reality platform for music education - learn and play real instruments with adaptive social learning, multi-platform (live on Meta Quest; Pico, SteamVR, and Apple Vision Pro coming); the only AI element is tutoring.
