...
- [Lyra](https://devpost.com/software/lyra-ai-d5m1uw) - a voice-first AI piano teacher prototype Matt built with Museverse CTO Robin Spottiswoode: plug in a USB-MIDI keyboard, ask for a chord or a scale, play it, and get spoken feedback. ElevenLabs Agents with Gemini 2.5 Flash as the reasoning model, tool calls that play notes and read MIDI in the browser, hosted on Google Cloud Run. [Live demo](https://lyra-496416529200.us-central1.run.app/) and [video](https://www.youtube.com/watch?v=MmMOYiZboQ8). A prototype, not a shipped Museverse feature.
